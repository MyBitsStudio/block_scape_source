...
public class BZip2Decompressor {
	static final BZip2BlockEntry aBZip2BlockEntry4865 = new BZip2BlockEntry();

	static byte method5391(BZip2BlockEntry bzip2blockentry) {
		return (byte) method5394(1, bzip2blockentry);
	}

	public static void decompress(byte[] is, int i, byte[] is_0_, int i_1_, int i_2_) {
	...
	static void method5393(@NotNull BZip2BlockEntry bzip2blockentry) {
		boolean bool = false;
		...
		while (bool_23_) {
			...
			for (int i_26_ = 0; i_26_ < 16; i_26_++) {
				i_24_ = method5391(bzip2blockentry);
				bzip2blockentry.aBoolArray4921[i_26_] = i_24_ == 1;
			}
			...
			System.arraycopy(bzip2blockentry.anIntArray4900, 0, bzip2blockentry.anIntArray4927, 1, 256);
			...
			BZip2BlockEntry bzip2blockentry_75_ = null;
			...
			bool_23_ = bzip2blockentry.anInt4903 == bzip2blockentry.anInt4931 + 1 && bzip2blockentry.anInt4908 == 0;
		}
	}

	static int method5394(int i, @NotNull BZip2BlockEntry bzip2blockentry) {
		for (;;) {
	...
	static void method5396(@NotNull BZip2BlockEntry bzip2blockentry) {
	...
	static void method5398(@NotNull BZip2BlockEntry bzip2blockentry) {
