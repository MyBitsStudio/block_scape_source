...
public class Class535 {
	...
	public byte method6420(@NotNull Class330 class330, byte i, byte i_0_) throws IOException {
		int i_1_ = 1;
		do {
			int i_2_ = i >> 7 & 0x1;
			i <<= 1;
	...
	public byte method6422(@NotNull Class330 class330, int i) throws IOException {
		int i_4_ = 1;
		do {
