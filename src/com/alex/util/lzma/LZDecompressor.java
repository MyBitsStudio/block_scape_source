...
public class LZDecompressor {
    public static final Class525 aClass525_7175 = new Class525();
    
	@NotNull
	public static byte[] method5579(@NotNull RsBuffer class541_sub35, int i, int i_3_) throws IOException {
		ByteArrayInputStream bytearrayinputstream = new ByteArrayInputStream(class541_sub35.aByteArray10632);
		bytearrayinputstream.skip(class541_sub35.anInt10629 * 822738007L);
		return method7936(bytearrayinputstream, i, 988211963);
	}
	@NotNull
	public static byte[] method7936(@NotNull InputStream inputstream, int i, int i_2_) throws IOException {
		byte[] is = new byte[5];
