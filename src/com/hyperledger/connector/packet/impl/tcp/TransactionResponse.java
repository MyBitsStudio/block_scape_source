...
public class TransactionResponse extends BlockchainPacket {

    public TransactionResponse(BlockchainConnector connect) {
        super(BlockchainPacketOpcode.TRANSACTION_RESPONSE, connect);
    }
