...
public final class Settings {
	...
	public static final String SERVER_NAME = "Corrupt";
	public static final String REPOSITORY = "information/";

	public static final int DROP_RATE = 3;

	/** Message to send on login **/
	public static String LATEST_UPDATE = "Corrupt in development";

	/* Server management */
	public static final int REVISION = 718; // revision of the client
	public static final int SUB_REVISION = 3; // client sub-build
	public static final int MINIMUM_RAM_ALLOCATED = 1000000000; // 1000mb
	public static int SERVER_PORT = 43594;// 43594;
	public static int WORLD_ID = 1;
	public static String host = "127.0.0.1";

	/** SQL IP connection **/
	public static String WEBHOST_IP = "";
	public static boolean SQL_ENABLED = true;

	/** Player configurations **/
	public static final int START_PLAYER_HITPOINTS = 100;
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(3227, 2778, 0);
	public static final WorldTile RESPAWN_PLAYER_LOCATION = new WorldTile(3227, 2778, 0);
	...
	// staffs
	public static String[] OWNER = { "corrupt", "quantum", "test" };
