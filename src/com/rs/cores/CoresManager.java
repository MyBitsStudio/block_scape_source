...
public final class CoresManager {
	...
	public static class ServiceProvider {
		 ...
		 * @param unit the specified time unit
		 */
		public void scheduleAndTrackRepeatingTask(@NotNull TrackedRunnable r, long startDelay, long delayCount, TimeUnit unit) {
		...
		@Contract(pure = true)
		private @NotNull String log(String message) {
