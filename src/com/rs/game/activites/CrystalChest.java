...
public class CrystalChest {
     ...
     * Item rewards.
     */
    private static final Item[] COMMON = { new Item(386, Utils.random(10, 100)),
    ...
    private static final Item[] UNCOMMON = { new Item(4153, 1), new Item(10564), new Item(10589),
    ...
    private static final Item[] RARE = { new Item(6914, 1), new Item(20440), new Item(20444), new Item(20436),
    ...
    private static final Item[] VERY_RARE = { new Item(4860), new Item(4866),
