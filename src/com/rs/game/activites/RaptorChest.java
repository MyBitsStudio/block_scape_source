...
public class RaptorChest {
     ...
     */
    private static final Item RKEY = new Item(36066);
    ...
    private static final Item[] COMMON = { new Item(4151, 1), new Item(4153, 1), new Item(11235, 1),  new Item(15486, 1),
    ...
    private static final Item[] UNCOMMON = { new Item(4152, 2), new Item(4154, 2), new Item(11236, 2),  new Item(15487, 2),
    new Item(29863, 2), new Item(6571, 2), new Item(24512, 1), new Item(30746, 1), new Item(30747, 1), new Item(30748, 1),   
    new Item(36066, 1)
            };

    private static final Item[] RARE = {new Item(29863, 4), new Item(36004, 1), new Item(36008, 1), new Item(35985, 1),
    ...
    private static final Item[] VERY_RARE = {new Item(29863, 6), new Item(36035, 1), new Item(36036, 1), new Item(36037, 1),
    ...
    public static void addRaptorReward(Player player) {
		...
		for(int i = 0; i < rewards.length; i++){
			if(rewards[i].getId() == 995){
				withCoins = rewards[i].getAmount();
				rewards[i] = null;
				break;
			}
		}
		if(withCoins > 0){
			ServerTransactionRequestPacket packet = new ServerTransactionRequestPacket(player, BlockchainUtils.coinToChain(withCoins), "Block Coin");
...
//			player.getAchManager().addKeyAmount("Raptor", 1);
		    ...
		    WorldTasksManager.schedule(new WorldTask() {
		    	...
		    	public void run() {
		    		...
		    		if (player.getPerks().isUnlocked(Perks.KEY_EXPERT.getId()))
			    		addRaptorReward(player);
		    		player.unlock();
		    		this.stop();
		    	}
