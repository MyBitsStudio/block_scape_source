...
public class DuelRules {
    ...
    public void setRule(int ruleId, boolean value) {
		duelRules[ruleId] = value;
	}
	...
	public static void sendRewardGivenUpdate(@NotNull Player victor, @NotNull Player loser, boolean hasGiven) {
