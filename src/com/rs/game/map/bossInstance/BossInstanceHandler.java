...
public class BossInstanceHandler {
	...
	public static enum Boss {
												...
												"GodWars", -1), Zamorak(GodWarsInstance.class, 2000000, 50, false, true,
														...
														null, "GodWars", -1), Saradomin(GodWarsInstance.class, 2000000,
																...
																-1), Armadyl(GodWarsInstance.class, 2000000, 50, false,
																		...
																		new WorldTile(2835, 5295, 0), null																		
																		, "GodWars",
																		-1),Vorago(VoragoInstance.class, 10000000, 50, true, true, new WorldTile(2972, 3431, 0), new WorldTile(3043, 6100, 0), new WorldTile(3072, 6176, 0), "VoragoInstanceController", 1155),
		NexAngel(GodWarsInstance.class, 2000000, 50, false,
				true, new WorldTile(2848, 1824, 1),
				new WorldTile(2848, 1825, 1), null, "GodWars",
				-1)
		;
		...
		Boss(Class<? extends BossInstance> instance, int initialCost, int maxPlayers, boolean hasHM,
