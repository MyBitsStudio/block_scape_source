...
public class GiantMoleCombat extends CombatScript {
	...
	private static final WorldTile[] COORDS =  {
		new WorldTile(1781, 5233, 0),
		new WorldTile(1757, 5228, 0),
		new WorldTile(1737, 5237, 0),
		new WorldTile(1736, 5197, 0),
		new WorldTile(1754, 5193, 0)
	};
	@Override
