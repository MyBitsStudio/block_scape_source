	...
	public int attack(NPC npc, Entity target) {
		...
		for (Entity t : npc.getPossibleTargets()) {
			if (Utils.getRandom(2) == 0)
				...
				delayHit(npc, 1, t, getRangeHit(npc, getRandomMaxHit(npc, 620, NPCCombatDefinitions.RANGE, t)));
				World.sendProjectile(npc, t, 1197, 41, 16, 41, 35, 16, 0);
				/*
				 * WorldTile teleTile = t; for (int trycount = 0; trycount < 10;
				 * trycount++) { teleTile = new WorldTile(t, 2); if
				 * (World.canMoveNPC(t.getPlane(), teleTile.getX(),
