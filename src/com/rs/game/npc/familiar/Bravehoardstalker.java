...
public class Bravehoardstalker extends Familiar {
	...
	public Bravehoardstalker(Player owner, Pouches pouch, WorldTile tile, int mapAreaNameHash, boolean canBeAttackFromOutOfArea) {
	...
	public void processNPC() {
		...
		if (forageTicks == 300) {
			forageTicks = 0;
			//XXX getBob().getBeastItems().add(new Item(DungeonConstants.HOARDSTALKER_ITEMS[4][Utils.random(5)], 1));
		}
	}
