...
public class Cubhoardstalker extends Familiar {
	...
	public Cubhoardstalker(Player owner, Pouches pouch, WorldTile tile, int mapAreaNameHash, boolean canBeAttackFromOutOfArea) {
	...
	public void processNPC() {
		...
		if (forageTicks == 300) {
			forageTicks = 0;
			//getBob().getBeastItems().add(new Item(DungeonConstants.HOARDSTALKER_ITEMS[0][Utils.random(5)], 1));
		}
	}
