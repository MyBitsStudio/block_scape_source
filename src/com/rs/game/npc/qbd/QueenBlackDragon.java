...
public final class QueenBlackDragon extends NPC {
	...
	private static final int[][] REWARDS = { { 1149, 1, 1, 57 }, // Dragon helm
			...
			{ 25758, 1, 1, 4 } // Draconic visage current
	};
	...
	public void setPhase(int phase) {
		...
		case 5:
			...
			attacker.sendMessage("<col=33FFFF>The enchantment is restored! "
					+ "Queen Black Dragon falls back into her cursed slumber.</col>");
			ContractHandler.checkContract(attacker, id, this);
