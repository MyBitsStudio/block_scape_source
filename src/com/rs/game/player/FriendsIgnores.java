...
public class FriendsIgnores implements Serializable {
	...
	public boolean isOnline(Player p2) {
		...
		if (player.getFriendsIgnores().privateStatus == 1
				&& !player.getFriendsIgnores().friends.contains(player.getUsername())) {
			return false;
		}
	...
	public void sendMessage(Player p2, String message) {
		...
		p2.getPackets().receivePrivateMessage(Utils.formatPlayerNameForDisplay(player.getDisplayName()),
