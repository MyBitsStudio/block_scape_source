...
public class PerkManager implements Serializable {
	...
	public boolean bankCommand, staminaBoost, greenThumb, birdMan, unbreakableForge, sleightOfHand, familiarExpert,
			...
			huntsman, portsMaster, investigator, divineDoubler, imbuedFocus, alchemicSmith, petLoot, mastersorcerer, petmaster, basher, butcher, lifeSteal, regenerator, breath,HazelmereLuck,
