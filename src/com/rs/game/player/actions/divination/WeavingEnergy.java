...
public class WeavingEnergy extends Action {
		...
		Energy(int levelRequired, double experience, Item[] itemsRequired, Item energyProduce) {
    ...
    public boolean process(Player player) {
    	limit = player.getPerks().isUnlocked(Perks.DIVINE.getId()) ? 2 : 1;
		if (energy == null)
		    return false;
		if (ticks <= 0)
			return false;
