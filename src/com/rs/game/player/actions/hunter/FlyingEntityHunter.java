...
public class FlyingEntityHunter {
	...
	public enum FlyingEntities {
		...
		EASTER_IMPLING(7420, 14727, 103, 153, 1,
				new Item[] { new Item(1705, Utils.random(1, 3)), new Item(1684, 3),
						new Item(1618, Utils.random(17, 34)) },
				new Item[] { new Item(1631, 1), new Item(1615, 1), new Item(9341, Utils.random(30)),
						new Item(9342, Utils.random(50)), new Item(11212, Utils.random(5,10)),
						new Item(9193, Utils.random(8)), new Item(11230, Utils.random(10, 50)),
						new Item(11232, Utils.random(17, 34)), new Item(1306, Utils.random(1, 2)), new Item(1249, 1) },
				new Item[] { new Item(9194, Utils.random(1, 10))},
				new Item[] { new Item(7158, 1), new Item(2366, 1), new Item(6571, 1),
						 });
	...
	public static void openJar(Player player, FlyingEntities instance, int slot) {
		...
		if (isImpling) {
			...
			//easter egg drop
			if(instance.getReward() == 14727){
			double rng = Utils.random(100);
			if(rng == 0 || rng == 1){
				Item[] eggs = {new Item(7928,1), new Item(7929, 1), new Item(7930, 1), new Item(7931, 1), new Item(7932, 1),new Item(7933, 1) };
				int randomEggs = eggs[Utils.random(eggs.length)].getId();
				String jarName = ItemDefinitions.getItemDefinitions(instance.getReward()).getName();
				String eggName = ItemDefinitions.getItemDefinitions(randomEggs).getName();
				player.getInventory().addItemDrop(randomEggs,1);
				World.sendWorldMessage(Colors.orange + "<shad=000000><img=6>News: " + player.getDisplayName()
				+ " received " + eggName + " from " + jarName + ".", false);
				}
			}
