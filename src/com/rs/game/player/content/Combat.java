...
public final class Combat {
    ...
    public static boolean hasAntiDragProtection(Entity target) {
		...
		return shieldId == 1540 || shieldId == 11283 || shieldId == 11284  || shieldId == 41450 || p2.getPerks().isUnlocked(Perks.DRAGON_TRAINER.getId());
    }
	...
	public static String getProtectMessage(Player player) {
		...
		if (player.getPerks().isUnlocked(Perks.DRAGON_TRAINER.getId()))
    ...
    public static boolean hasDFS(Player player) {
		...
		return shieldId == 1540 || shieldId == 11283 || shieldId == 11284 || shieldId == 25558
				 ...
				 || shieldId == 41450 || player.getPerks().isUnlocked(Perks.DRAGON_TRAINER.getId());
	}
