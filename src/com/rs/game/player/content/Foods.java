...
public class Foods {
	...
	public static enum Effect {
		...
		ONION_MESSAGE {
			...
			public void effect(Object object) {
				Player player = (Player) object;
				player.getPackets()
						.sendGameMessage("It hurts to see a grown " + player.getGlobalPlayerUpdater().isMale() != null
	...
	public static enum Food {
		 ...
		 * Easter eggs.
		 */
		/*EASTER_EGG_1(7928, 14), 
		EASTER_EGG_2(7929, 14), 
		EASTER_EGG_3(7930, 14), 
		EASTER_EGG_4(7931, 14), 
		EASTER_EGG_5(7932, 14), 
		EASTER_EGG_6(7933, 14),*/
