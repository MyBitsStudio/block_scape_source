...
public final class LocalNPCUpdate {
	...
	private void addInScreenNPCs(OutputStream stream, OutputStream updateBlockData, boolean largeSceneView) {
		for (int regionId : player.getMapRegionsIds()) {
			...
			for (int npcIndex : indexes) {
				...
				boolean needUpdate = n.needMasksUpdate() || n.getLastFaceEntity() != -1 || n.getCustomCombatLevel() >= 0
	...
	/*
	 * if ((mask & 0x400) != 0) {// ordinal 13 other bar thing int i_47_ =
	 * stream.readUnsignedShortLE128(1478539457); npc.anInt10088 =
	 * (stream.readUnsignedByte() * 918505277); npc.anInt10096 =
	 * (stream.readUnsigned128Byte((byte) 19) * -494980103); npc.aBoolean10119 =
	 * (i_47_ & 0x8000) != 0; npc.anInt10087 = (i_47_ & 0x7fff) * -257621575;
	 * npc.anInt10086 = (npc.anInt10088 * 1195117671 + (client.ticketCycle *
	 * 1208636921 + (-1132907677 * npc.anInt10087))); }
	 */
	...
	private void applyFaceWorldTileMask(NPC n, OutputStream data) {
		...
		data.writeShortLE128((n.getNextFaceWorldTile().getY() * 2) + n.getNextFaceWorldTile().getSizeY());
	}
