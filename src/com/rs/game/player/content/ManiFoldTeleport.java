	...
	public static void openInterface(Player player, String name, int index, boolean isGroupTeleport) {
		player.getDialogueManager().startDialogue(new Dialogue() {
			...
			public void start() {
				...
				player.getPackets().sendIComponentText(REQUEST_INTERFACE, 1, Utils.formatString(name));
				player.getPackets().sendIComponentText(REQUEST_INTERFACE, 3, TELEPORT_NAMES[isGroupTeleport ? 0 : 1][index]);
			}
