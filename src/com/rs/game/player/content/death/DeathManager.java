...
public class DeathManager implements Serializable {
	...
	public static final void sendItemsKeptOnDeathInterface(Player player, boolean toggle, boolean inWilderness) {
		...
		builder.append("<br><br>Current gravestone:<br>" + GRAVESTONES[player.getPlayerVars().getGravestone()][0] + "<br><br>Duration:<br>" + GRAVESTONES[player.getPlayerVars().getGravestone()][1]);
