...
import com.rs.game.player.content.dungeoneering.skills.DungeoneeringSmelting.SmeltingBar;

public class DungeonConstants {

	/*
	 * 1049 Floor Settings inter 1388 map
	 */
	...
	public static final int[] RUNES = { 17780, 17781, 17782, 17783, 17784, 17785, 17786, 17787, 17788, 17789, 17790,
			17791, 17792, 17793 };
	...
	public static enum SkillDoors {
		RUNED_DOOR(Skills.RUNECRAFTING, new int[] { 50278, 50279, 50280, 53953, 55741 }, 791, 186, -1, -1, -1, -1,
				"You imbue the door with the wrong type of rune energy, and it reacts explosively."), BARRED_DOOR(
						Skills.STRENGTH, new int[] { 50272, 50273, 50274, 53951, 55739 },
						new int[] { 50275, 50276, 50277, 53952, 55740 }, -1, -1, -1, -1, -1, -1,
						"You pull a muscle while attempting to move the plank."), PILE_OF_ROCKS(Skills.MINING,
								new int[] { 50305, 50306, 50307, 53962, 55750 }, -2, -1, 13559, -1, -1, 2420,
								"You fail to mine the obstruction, and are harmed by falling debris."), FLAMMABLE_DEBRIS(
										Skills.FIREMAKING, new int[] { 50314, 50315, 50316, 53965, 55753 }, 16700, -1,
										13562, 13563, -1, -1,
										"The pile of debris fails to ignite. The same cannot be said for your clothes."), MAGICAL_BARRIER(
												Skills.MAGIC, new int[] { 50329, 50330, 50331, 53970, 55758 }, 4411, -1,
												13551, 13550, -1, -1,
		...
		private SkillDoors(int skillId, int[] closedThemeObjects, int openAnim, int openGfx, int openObjectAnim,
				int failObjectAnim, int failAnim, int failGfx, String failMessage) {
			this(skillId, closedThemeObjects, null, openAnim, openGfx, openObjectAnim, failObjectAnim, failAnim,
					failGfx, failMessage);
		}
		 ...
		 */
		private SkillDoors(int skillId, int[] closedThemeObjects, int[] openThemeObjects, int openAnim, int openGfx,
				int openObjectAnim, int failObjectAnim, int failAnim, int failGfx, String failMessage) {
	...
	public static enum KeyDoors {
		ORANGE_TRIANGLE(0), ORANGE_DIAMOND(1), ORANGE_RECTANGLE(2), ORANGE_PENTAGON(3), ORANGE_CORNER(
				4), ORANGE_CRESCENT(5), ORANGE_WEDGE(6), ORANGE_SHIELD(7), SILVER_TRIANGLE(8), SILVER_DIAMOND(
						9), SILVER_RECTANGLE(10), SILVER_PENTAGON(11), SILVER_CORNER(12), SILVER_CRESCENT(
								13), SILVER_WEDGE(14), SILVER_SHIELD(15), YELLOW_TRIANGLE(16), YELLOW_DIAMOND(
										17), YELLOW_RECTANGLE(18), YELLOW_PENTAGON(19), YELLOW_CORNER(
												20), YELLOW_CRESCENT(21), YELLOW_WEDGE(22), YELLOW_SHIELD(
														23), GREEN_TRIANGLE(24), GREEN_DIAMOND(25), GREEN_RECTANGLE(
																26), GREEN_PENTAGON(27), GREEN_CORNER(
																		28), GREEN_CRESCENT(29), GREEN_WEDGE(
																				30), GREEN_SHIELD(31), BLUE_TRIANGLE(
																						32), BLUE_DIAMOND(
																								33), BLUE_RECTANGLE(
																										34), BLUE_PENTAGON(
																												35), BLUE_CORNER(
	...
	public static final double[][] DUNGEON_DIFFICULTY_RATIO_BONUS = { { 0 }, { -0.07, 0.05 }, { -0.14, 0.02, 0.1 },
			{ -0.21, -0.07, 0.06, 0.15 }, { -0.29, -0.12, 0.04, 0.11, 0.19 } };
	/*
	 * floor types
	 */
	public static final int FROZEN_FLOORS = 0, ABANDONED_FLOORS = 1, FURNISHED_FLOORS = 2, OCCULT_FLOORS = 3,
			WARPED_FLOORS = 4;
	...
	public static final int[] SLAYER_CREATURES = { 10694, 10695, 10696, 10697, 10698, 10699, 10700, 10701, 10702, 10704,
			10705 };

	/*
	 * id - lvl
	 */
	public static final int[] HUNTER_CREATURES = { 11086, 11087, 11088, 11089, 11090, 11091, 11092, 11093, 11094,
			11095 };

	public static final StartRoom[] START_ROOMS = new StartRoom[] {
			// FROZEN_FLOORS
			new StartRoom(14, 632, EAST_DOOR, WEST_DOOR, NORTH_DOOR, SOUTH_DOOR), new StartRoom(14, 624, SOUTH_DOOR),
			new StartRoom(14, 626, WEST_DOOR, SOUTH_DOOR), new StartRoom(14, 630, WEST_DOOR, NORTH_DOOR, SOUTH_DOOR) };

	public static final NormalRoom[] NORMAL_ROOMS = new NormalRoom[] { new NormalRoom(8, 240, spot(3, 7), SOUTH_DOOR),
			...
			new NormalRoom(12, 256, spot(9, 7), SOUTH_DOOR), new NormalRoom(12, 258, spot(3, 6), SOUTH_DOOR, WEST_DOOR),
			...
			new NormalRoom(52, 240, spot(7, 11), SOUTH_DOOR), new NormalRoom(54, 240, spot(8, 11), SOUTH_DOOR),
			new NormalRoom(56, 240, spot(3, 10), SOUTH_DOOR), new NormalRoom(58, 240, spot(3, 12), SOUTH_DOOR),
			new NormalRoom(60, 240, spot(9, 12), SOUTH_DOOR), new NormalRoom(62, 240, spot(12, 12), SOUTH_DOOR),
			new NormalRoom(64, 240, spot(2, 12), SOUTH_DOOR), new NormalRoom(66, 240, spot(8, 10), SOUTH_DOOR),
			new NormalRoom(68, 240, spot(3, 7), SOUTH_DOOR), new NormalRoom(70, 240, spot(8, 12), SOUTH_DOOR),
			new NormalRoom(72, 240, spot(12, 7), SOUTH_DOOR), new NormalRoom(74, 240, spot(4, 10), SOUTH_DOOR),
			new NormalRoom(76, 240, spot(8, 7), SOUTH_DOOR), new NormalRoom(78, 240, spot(3, 4), SOUTH_DOOR),
	...
	public static enum MapRoomIcon {
		...
		MAP_1(2791, true, SOUTH_DOOR), MAP_2(2792, true, WEST_DOOR), MAP_3(2793, true, NORTH_DOOR), MAP_4(2794, true,
				EAST_DOOR), MAP_5(2795, true, WEST_DOOR, SOUTH_DOOR), MAP_6(2796, true, WEST_DOOR, NORTH_DOOR), MAP_7(
						2797, true, NORTH_DOOR, EAST_DOOR), MAP_8(2798, true, SOUTH_DOOR, EAST_DOOR), MAP_9(2799, true,
								SOUTH_DOOR, WEST_DOOR,
								NORTH_DOOR), MAP_10(2800, true, WEST_DOOR, NORTH_DOOR, EAST_DOOR), MAP_11(2801, true,
										SOUTH_DOOR, NORTH_DOOR,
										EAST_DOOR), MAP_12(2802, true, SOUTH_DOOR, WEST_DOOR, EAST_DOOR), MAP_13(2803,
												true, SOUTH_DOOR, NORTH_DOOR, EAST_DOOR,
												WEST_DOOR), MAP_14(2804, true, SOUTH_DOOR, NORTH_DOOR), MAP_15(2805,
														true, WEST_DOOR,
														EAST_DOOR), MAP_16(2787, false, SOUTH_DOOR), MAP_17(2788, false,
																WEST_DOOR), MAP_18(2789, false,
																		NORTH_DOOR), MAP_19(2790, false, EAST_DOOR);
	...
	public static final int[][] PUZZLE_DOOR_ORDER = new int[][] { { SOUTH_DOOR, WEST_DOOR }, { SOUTH_DOOR, EAST_DOOR },
			{ SOUTH_DOOR, NORTH_DOOR }, { SOUTH_DOOR, NORTH_DOOR, WEST_DOOR }, { SOUTH_DOOR, EAST_DOOR, WEST_DOOR },
			{ SOUTH_DOOR, EAST_DOOR, NORTH_DOOR }, { SOUTH_DOOR, EAST_DOOR, NORTH_DOOR, WEST_DOOR }, };

	public static final HandledRoom[] PUZZLE_ROOMS;

	public static enum Puzzle {

		CRYSTAL_PUZZLE(12, CrystalPuzzleRoom.class, all(spot(13, 5))), TOXIN_MAZE(20, ToxinMaze.class, all(spot(7, 8)),
				false), FLIP_TILES(24, FlipTilesRoom.class, list(spot(1, 3), spot(1, 12), spot(1, 3), spot(14, 11),
						spot(14, 11), spot(1, 9), spot(1, 3))), FREMENNIK_CAMP(26, FremennikCampRoom.class, list(
								spot(6, 14), spot(10, 2), spot(14, 6), spot(5, 12), spot(13, 10), spot(3, 5),
								spot(13, 10))), FISHING_FERRET(32, FishingFerretRoom.class,
										all(spot(2, 1)),
										false), LEVERS(38, LeverRoom.class, list(spot(1, 5), spot(10, 14), spot(1, 5),
												spot(10, 14), spot(1, 5), spot(10, 14), spot(1, 5))), SLIDING_STATUES(
														42, SlidingStatuesRoom.class, all(spot(1, 3)),
														false), FLOWER_ROOTS(50, FlowerRootsRoom.class,
																list(spot(9, 10), spot(6, 7), spot(13, 12), spot(12,
																		12), spot(3, 6), spot(2, 11), spot(3, 11)),
																false), POLTERGEIST(52, PoltergeistRoom.class, list(
																		spot(1, 10), spot(2, 10), spot(3, 5),
																		spot(2, 4), spot(13, 4), spot(2, 12),
																		spot(3, 4))), UNHAPPY_GHOST(60,
																				UnhappyGhostRoom.class,
																				list(spot(2, 3), spot(3, 5), spot(3, 5),
																						spot(2, 2), spot(3, 3),
																						spot(2, 2), spot(4, 3)),
																				false), RETURN_THE_FLOW(66,
																						ReturnTheFlowRoom.class,
																						list(spot(3, 3), spot(2, 12),
																								spot(2, 2), spot(4, 2),
																								spot(3, 3), spot(2, 2),
																								spot(2, 2))), COLOURED_RECESS(
																										68,
																										ColouredRecessRoom.class,
																										list(spot(2, 3),
																												spot(2, 3),
																												spot(2, 3),
																												spot(2, 3),
	...
	static {
		...
		for (Puzzle puzzle : Puzzle.values()) {
			// Force puzzle
			/*
			 * if (!Settings.HOSTED) { puzzle = Puzzle.SLIDING_STATUES; }/* else
			 * if(puzzle == Puzzle.COLOURED_RECESS) { //don't use in progress
			 * one on live instead replace it with last added one (more bug
			 * testers!) puzzle = Puzzle.SLIDING_STATUES; }
			 */
	...
	public static final int[][] WALL_BASE_X_Y = { { 14, 1, 0, 14 }, { 1, 1, 14, 0 }, { 1, 1, 0, 14 },
			{ 1, 14, 14, 0 } };
	...
	public static final int NORMAL_NPC = 0, GUARDIAN_NPC = 1, FISH_SPOT_NPC = 2, BOSS_NPC = 3, FORGOTTEN_WARRIOR = 4,
			SLAYER_NPC = 5, HUNTER_NPC = 6, PUZZLE_NPC = 7;

	public static SmeltingBar[] SMELTING_BARS = new SmeltingBar[] { SmeltingBar.NOVITE, SmeltingBar.BATHUS,
			SmeltingBar.MARMAROS, SmeltingBar.KRATONITE, SmeltingBar.FRACTITE, SmeltingBar.ZEPHYRIUM,
			SmeltingBar.ARGONITE, SmeltingBar.KATAGON, SmeltingBar.GORGONITE, SmeltingBar.PROMETHIUM };

	public static int[] GROUP_GATESTONE_RUNES = { 17792, 3 };

	public static final int[][] HOARDSTALKER_ITEMS = { { 17630, 17424, 17682, 17448, 17797 },
			{ 17632, 17426, 17684, 17450, 17799 }, { 17634, 17428, 17686, 17452, 17801 },
			{ 17636, 17430, 17688, 17454, 17803 }, { 17638, 17432, 17700, 17456, 17805 },
			{ 17640, 17434, 17702, 17458, 17807 }, { 17642, 17436, 17704, 17460, 17809 },
			{ 17644, 17438, 17706, 17462, 17811 }, { 17646, 17440, 17708, 17464, 17813 },
