...
public class CutscenesHandler {
    ...
    public static final void init() {
		try {
			...
			Class<Cutscene> value7 = (Class<Cutscene>) Class.forName(HomeCutScene.class.getCanonicalName());
			handledCutscenes.put("HomeCutScene", value7);
			Class<Cutscene> value8 = (Class<Cutscene>) Class.forName(StartingCutscene.class.getCanonicalName());
			handledCutscenes.put("StartingCutscene", value8);
		} catch (Throwable e) {
		    Logger.handle(e);
		}
    }
