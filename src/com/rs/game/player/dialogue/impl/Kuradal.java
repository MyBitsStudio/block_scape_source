	...
	public void run(int interfaceId, int componentId) {
		...
		case 1:
			if (player.getTask() == null) {
				...
				sendNPCDialogue(npcId, 9827, "You're still hunting " + player.getTask().getName().toLowerCase() + "s; "
		...
		case 43:
			...
			break;
		case 44:
			sendNPCDialogue(npcId, 9827, "Hahaha! The look on your face! That cheered me up some. Thanks, " + Utils.formatString(player.getDisplayName()) + ".");
			stage = 45;
			break;
		case 45:
		...
		case 79:
			...
			sendNPCDialogue(npcId, 9827, "Great hunting, " + Utils.formatString(player.getDisplayName()) + ".");
			stage = 100;
			break;
		case 100:
			end();
