	...
	public void run(int interfaceId, int componentId) {
		...
		if (!room.canTakeHerb()) {
			...
			if (componentId == OPTION_1) {
				...
				stage = 0;
				sendOptionsDialogue("Select an Option", "Pick cardamaim.", "Pick papreaper.", "Pick slaughtercress.",
						"More herbs.");
			...
			if (componentId == OPTION_1) {
				...
				stage = -1;
				sendOptionsDialogue("Select an Option", "Pick corianger.", "Pick explosemary.", "Pick parslay.",
						"More herbs.");
			}
		}
	}
