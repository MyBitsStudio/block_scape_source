...
import com.rs.game.player.content.dungeoneering.skills.DungeoneeringSmelting;
...
public class SingleSmithingD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		player.getActionManager()
				.setAction(new DungeoneeringSmelting(bars[idx], object, SkillsDialogue.getQuantity(player)));
		end();
	}
