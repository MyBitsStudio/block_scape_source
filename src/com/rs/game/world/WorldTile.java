...
public class WorldTile implements Serializable {
	...
	public int getLocalX(WorldTile tile, int mapSize) {
		return x - 8 * (tile.getChunkX() - (Protocol.MAP_SIZES[mapSize] >> 4));
	}

	public int getLocalY(WorldTile tile, int mapSize) {
		return y - 8 * (tile.getChunkY() - (Protocol.MAP_SIZES[mapSize] >> 4));
	}

	public int getLocalX32(WorldTile tile, int mapSize) {
		return x - 32 * (tile.getChunkX() - (Protocol.MAP_SIZES[mapSize] >> 4));
	}

	public int getLocalY32(WorldTile tile, int mapSize) {
		return y - 32 * (tile.getChunkY() - (Protocol.MAP_SIZES[mapSize] >> 4));
	}
	...
	public int getLocalX32(WorldTile tile) {
		return getLocalX32(tile, 5);
	}

	public int getLocalY32(WorldTile tile) {
		return getLocalY32(tile, 3);
	}
	...
	public int getLocalX32() {
		return getLocalX32(this);
	}

	public int getLocalY32() {
		return getLocalY32(this);
	}
