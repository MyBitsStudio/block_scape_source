...
import com.corrupt.raids.controllers.CorruptedCrystalController;
import com.corrupt.raids.controllers.DragonBurstController;
import com.corrupt.raids.controllers.MazcabRaidController;
import com.corrupt.raids.controllers.TuskenRaidController;
...
import com.rs.game.world.controllers.bossInstance.*;
...
import com.rs.game.world.controllers.fightpits.FightPitsLobby;
...
import com.rs.game.world.controllers.zombie.ZombieLobbyControler;
...
*/
			...
			handledControlers.put("RiseOfTheSix",
					(Class<Controller>) Class.forName(RiseOfTheSix.class.getCanonicalName()));
			/*
			 * handledControlers.put("VoragoController", (Class<Controller>)
			 * Class.forName(VoragoController.class.getCanonicalName()));
			 * handledControlers.put("VoragoLobbyController", (Class<Controller>)
			 * Class.forName(VoragoLobbyController.class.getCanonicalName()));
			 */
			...
			handledControlers.put("PartyDemonController",
					(Class<Controller>) Class.forName(PartyDemonController.class.getCanonicalName()));
			...
			handledControlers.put("ZOControler",
					(Class<Controller>) Class.forName(ZOControler.class.getCanonicalName()));
			handledControlers.put("CitadelControler",
					(Class<Controller>) Class.forName(CitadelControler.class.getCanonicalName()));

			//Raids
			handledControlers.put("RaidsController",
					(Class<Controller>) Class.forName(RaidsController.class.getCanonicalName()));
			handledControlers.put("TuskenRaidController",
					(Class<Controller>) Class.forName(TuskenRaidController.class.getCanonicalName()));
			handledControlers.put("MazcabRaidController",
					(Class<Controller>) Class.forName(MazcabRaidController.class.getCanonicalName()));
			handledControlers.put("CorruptedCrystalController",
					(Class<Controller>) Class.forName(CorruptedCrystalController.class.getCanonicalName()));
			handledControlers.put("DragonBurstController",
					(Class<Controller>) Class.forName(DragonBurstController.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
