						...
						public void run() {
							...
							WorldTasksManager.schedule(new WorldTask() {
								...
								public void run() {
									...
									player.getPackets().sendGameMessage("The falcon successfully swoops down and captures the kebbit.", true);
								...
								public void run() {
									...
									WorldTasksManager.schedule(new WorldTask() {
										...
										public void run() {
											...
											player.getPackets().sendGameMessage("The falcon swoops down on the kebbit, but just barely misses catching it.", true);
										}
									});
								}
