...
import com.rs.game.player.actions.sawmill.ConveyorBeltHopper;
import com.rs.game.player.actions.sawmill.CutPlank;
import com.rs.game.player.actions.sawmill.PlanksTake;
import com.rs.game.player.actions.sawmill.StackOfLogs;
...
public class SawmillController extends Controller {
	...
	public boolean isPlanksFull() {
		return planks >= (player.isBronze() ? 126 : 100);
	}
