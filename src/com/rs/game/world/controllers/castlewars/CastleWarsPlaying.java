package com.rs.game.world.controllers.castlewars;
...
public class CastleWarsPlaying extends Controller {
	...
	if (player.getX() >= 2368 && player.getX() <= 2376
		&& player.getY() >= 3127 && player.getY() <= 3135
		|| player.getX() >= 2423 && player.getX() <= 2431
		&& player.getY() >= 3072 && player.getY() <= 3080)
	    return true;
	return false;
    }
