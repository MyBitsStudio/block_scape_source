...
public final class NPCSpawns {
	...
	public static void addCustomSpawns() {
		// easter bunny for rewards
		/*
		 * new NPC(13651, new WorldTile(3793, 4503, 1), -1, false); // bunny
		 * World.spawnNPC(3847,new WorldTile(1623,4570,0), -1,true);//sea troll queen
		 * World.spawnNPC(1552,new WorldTile(2126,6952,0), -1,false);//santa
		 * World.spawnNPC(14256,new WorldTile(2200,4264,1), -1,true);//lucien
	...
	//	World.spawnNPC(552, new WorldTile(979, 4123, 0), -1, true, EntityDirection.EAST);
		...
		//masuta
		World.spawnNPC(25589, new WorldTile(3237, 3621, 0), -1, true);
		// Airut
		...
		World.spawnNPC(21812, new WorldTile(5148, 7517, 0), -1, true);
		World.spawnNPC(21812, new WorldTile(5137, 7517, 0), -1, true);
		World.spawnNPC(21812, new WorldTile(5132, 7502, 0), -1, true);
		World.spawnNPC(21812, new WorldTile(5165, 7510, 0), -1, true);
		World.spawnNPC(21812, new WorldTile(5148, 7508, 0), -1, true);
		// Telos
		...
		//Nex Angel of death
		//World.spawnNPC(24004, new WorldTile(2848, 1824, 1), -1, true, EntityDirection.NORTH);
