...
public final class ObjectSpawns {
	...
	public static void addCustomSpawns() {
		/*NEW HOME*/ /*CITY OF GOLD*/
		//thieving stalls /*CITY OF GOLD*/
      	World.spawnObject(new WorldObject(4874, 10, 0, new WorldTile(985, 4115, 0)), true);
      	World.spawnObject(new WorldObject(4875, 10, 0, new WorldTile(984, 4115, 0)), true);
      	World.spawnObject(new WorldObject(4876, 10, 0, new WorldTile(983, 4115, 0)), true);
      	World.spawnObject(new WorldObject(4877, 10, 0, new WorldTile(982, 4115, 0)), true);
      	World.spawnObject(new WorldObject(4878, 10, 0, new WorldTile(981, 4115, 0)), true);
      	//BANK /*CITY OF GOLD*/
		...
		//crate
		/**World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3201, 2726, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3201, 2727, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3201, 2728, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3201, 2729, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3201, 2730, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3201, 2731, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3226, 2745, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3227, 2745, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3228, 2745, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3229, 2745, 0)), true);
		World.spawnObject(new WorldObject(100916, 10, 1, new WorldTile(3230, 2745, 0)), true);
		**/
		//board
